...
const VARIANTS = {
  primary: 'bg-[#D2D5D8] text-[#0B0F14] border border-white/10 shadow-sm hover:bg-[#D9DCDF] active:bg-[#C5C9CD] active:shadow-none disabled:cursor-not-allowed disabled:bg-white/10 disabled:text-white/30 disabled:shadow-none',
  secondary: 'bg-[#D2D5D8] text-[#0B0F14] border border-white/10 hover:bg-[#D9DCDF] active:bg-[#C5C9CD] disabled:cursor-not-allowed disabled:opacity-40',
  ...
  gradient: 'bg-[#D2D5D8] text-[#0B0F14] shadow-sm hover:bg-[#D9DCDF] active:bg-[#C5C9CD] disabled:cursor-not-allowed disabled:opacity-40',
