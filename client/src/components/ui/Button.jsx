...
const VARIANTS = {
  ...
  gradient: 'bg-gradient-to-r from-[#EC2FA8] to-[#8A2BE2] text-white shadow-[0_10px_24px_-10px_rgba(236,47,168,0.5)] hover:brightness-110 active:brightness-90 active:shadow-none disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none',
