...
const VARIANTS = {
  primary: 'bg-[#11161D] text-white border border-white/10 shadow-sm hover:bg-[#171D25] hover:border-white/15 active:bg-[#0D1218] active:shadow-none disabled:cursor-not-allowed disabled:bg-white/10 disabled:text-white/30 disabled:shadow-none',
  ...
  gradient: 'bg-[#E7E9EA] text-[#0B0F14] text-white shadow-sm hover:bg-[#D9DDE1] active:bg-[#1A8CD8] active:shadow-none disabled:cursor-not-allowed disabled:opacity-40 disabled:shadow-none',
