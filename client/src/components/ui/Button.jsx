...
const Button = forwardRef(function Button({ variant = 'primary', size = 'md', className = '', type = 'button', style, invisible = false, ...props }, ref) {
  ...
  return <button ref={ref} type={type} className={`${sizeClass} ${variantClass} ${pressClass} transition duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3B82F6]/60 ${className}`.trim()} style={buttonStyle} {...props} />;
});
