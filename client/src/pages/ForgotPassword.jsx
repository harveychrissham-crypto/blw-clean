    ...
    <section className="min-h-screen w-full bg-slate-950">
      <div className="mx-auto flex min-h-screen w-full max-w-xl items-center px-4 py-20 sm:px-6">
        <Card variant="raised" className="w-full p-8 sm:p-10">
          <Button variant="link" size="none" onClick={() => navigate('/auth')} className="text-sm text-slate-400 hover:text-white">← Back to sign in</Button>
          ...
          <form onSubmit={submit} className="mt-8 space-y-4">
            ...
            <Button type="submit" variant="gradient" disabled={status === 'submitting'} className="inline-flex w-full justify-center">
