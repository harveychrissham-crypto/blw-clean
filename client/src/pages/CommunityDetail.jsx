...
export default function CommunityDetail() {
  ...
  if (!data?.community) return <main className="grid min-h-screen place-items-center bg-[#0B0F14] px-6 text-center text-white"><div><p className="font-bold">{error || 'Community not found.'}</p><button onClick={() => navigate('/communities')} className="mt-4 rounded-xl bg-white px-5 py-2.5 text-sm font-semibold text-[#0B0F14] hover:bg-white/90">Back to communities</button></div></main>;
