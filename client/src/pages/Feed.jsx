...
import { FiAlertCircle, FiBookmark, FiHeart, FiLoader, FiMessageCircle, FiMoreHorizontal, FiSend, FiShare2, FiRepeat, FiVolume2, FiVolumeX, FiWifiOff, FiX, FiFlag, FiLink2, FiTrash2 } from 'react-icons/fi';
import { useAuth } from '../context/AuthContext';
import { useOnlineStatus } from '../hooks/useOnlineStatus';
import { fetchFeed, toggleLike, toggleSave, toggleRepost, toggleFollow, fetchComments, addComment, deleteComment, reportPost, deletePost, readCachedFeed, writeCachedFeed, recordFeedView } from '../utils/feed';
...
function PostCard({post,user,onUpdate,onRemove,onFollowUpdate,notificationId}) {
