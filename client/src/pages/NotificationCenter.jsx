    ...
    <section className="mx-auto max-w-3xl px-5 py-12">
      ...
      <Card as="form" onSubmit={handleSend} variant="custom" className="space-y-4 rounded-3xl border border-white/10 bg-white/[0.04] p-6">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <Button variant="custom" size="none" type="button" onClick={handleSelfTest} disabled={busy || loadingTargets || (targetType !== 'announcement' && !selectedTarget) || !title.trim() || !body.trim()} className="flex w-full items-center justify-center gap-2 rounded-2xl border border-[#EC2FA8]/25 bg-[#3C1464]/50 py-3 font-bold text-white disabled:opacity-50"><FiUserCheck /> {busy ? 'Sending…' : 'Send Test to Me'}</Button>
