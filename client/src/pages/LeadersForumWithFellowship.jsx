    ...
    <div data-leadership-tools-overlay className="fixed inset-0 z-[110] overflow-y-auto overscroll-contain bg-[#0d0c18]/98 backdrop-blur-xl">
      <div className="min-h-screen px-4 py-6 sm:px-6 lg:px-8"><div className="mx-auto max-w-5xl">
        ...
        <div className="space-y-8">
          <section><p className="mb-3 text-[10px] font-bold uppercase tracking-[0.3em] text-[#D8B2FF]">Attendance</p><div className="grid gap-3"><button onClick={onAttendance} className="group w-full max-w-md rounded-2xl border border-emerald-500/20 bg-emerald-950/35 p-4 text-left transition hover:-translate-y-0.5 hover:bg-emerald-950/50"><div className="flex items-center gap-3"><div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-500/10"><FiCheckCircle className="h-5 w-5 text-emerald-300" /></div><div className="min-w-0"><h3 className="font-bold text-white">Check Attendance</h3><p className="mt-1 text-xs leading-relaxed text-white/40">View today\'s signed-in members and offline attendance waiting to sync.</p></div></div></button></div></section>
