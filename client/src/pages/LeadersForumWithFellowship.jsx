...
function CSVDownload({ members, event }) {
  ...
  return <Button variant="secondary" size="md" onClick={exportCsv} className="inline-flex items-center gap-2"><FiDownload/> CSV</Button>;
}
