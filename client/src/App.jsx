...
import ContentAdminPanel from './pages/ContentAdminPanel';
...
const AnimatedRoutes = () => {
  const location = useLocation(); const navigationType = useNavigationType(); const { user } = useAuth(); const route = (element) => <Layout>{element}</Layout>; const prevPathRef = useRef(location.pathname);
