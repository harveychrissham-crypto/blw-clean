...
const navItems = [
  { name: 'Home', path: '/', icon: FiHome }, { name: 'Feed', path: '/feed', icon: FiMic }, { name: 'Communities', path: '/communities', icon: FiUsers }, { name: 'Meetings', path: '/meetings', icon: FiVideo },
];
